...
CREATE TABLE `tb_comentarios` (
  ...
  CONSTRAINT `tb_comentarios_ibfk_1` FOREIGN KEY (`usuario_id_fk`) REFERENCES `tb_usuario` (`id_usuario`),
  CONSTRAINT `tb_comentarios_ibfk_2` FOREIGN KEY (`ocorrencia_id_fk`) REFERENCES `tb_ocorrencia` (`id_ocorrencia`)
